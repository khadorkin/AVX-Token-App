...
export const MEDIA_PROGRESS = 'MEDIA_PROGRESS';

// Webtorrent
export const WEBTORRENT_ADD = 'WEBTORRENT_ADD';
export const WEBTORRENT_ADDED = 'WEBTORRENT_ADDED';
export const WEBTORRENT_REMOVE = 'WEBTORRENT_REMOVE';
export const WEBTORRENT_TORRENT = 'WEBTORRENT_TORRENT';
export const WEBTORRENT_PROGRESS = 'WEBTORRENT_PROGRESS';
export const WEBTORRENT_COMPLETE = 'WEBTORRENT_COMPLETE';
export const WEBTORRENT_ERROR = 'WEBTORRENT_ERROR';
